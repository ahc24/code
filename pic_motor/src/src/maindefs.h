...
#define MSGT_UART_BAD_CHECKSUM 32
#define MSGT_UART_BAD_COUNTER 33
#define MSGT_UART_BAD_START 34
#define MSGT_UART_BAD_END 35
#define MSGT_UART_ACK_DATA 36
